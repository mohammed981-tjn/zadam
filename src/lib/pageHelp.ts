...
const HELP: Record<string, PageHelp> = {
  ...
  "/export/market": {
    purpose:
      "العروض المنشورة التي يراها المشترون. كل عرض راجعه موظّف وتأكّد أنّ أدلّته تسند ما يقوله — المنشأ بإحداثيّته والأدلّة ببصماتها — لا أنّ البضاعة جيّدة ولا أنّ السعر عادل، فتلك تبقى لفحص المشتري.",
    common: [
      "ماذا تعني كلمة «مراجَع» هنا بالضبط؟",
      "كيف أتواصل بشأن عرض؟",
      "لماذا لا يظهر اسم المزارع؟",
    ],
  },
  "/export/offers": {
    purpose:
      "شاشة المزارع لتحويل موسم موثَّق إلى عرض تصدير. يُحفظ العرض مسوّدة، ولا يراه أحد حتى ترسله، ولا يُنشر حتى يراجعه موظّف ويتأكّد أنّ الأدلّة تسند ما يقوله. والوحدة اختيارية: بالرأس أو بالكيلو.",
    common: [
      "لماذا لا أستطيع نشر عرضي بنفسي؟",
      "ما الفرق بين مسوّدة ومُرسَل ومنشور؟",
      "متى تُطلب حدود القطعة بدل النقطة؟",
      "أُعيد إليّ العرض — ماذا أفعل؟",
    ],
  },
  "/arc-canal": {
    purpose:
