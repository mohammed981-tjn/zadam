...
insert into profiles (id, role) values
  ...
  ('b0000000-0000-0000-0000-00000000000b', 'investor'),
  ('c0000000-0000-0000-0000-00000000000c', 'investor')
on conflict (id) do nothing;

-- مشروعٌ فيه ١٠٠ حصة، بيعت منها ٩٠. فالمتبقّي ١٠ — وهو العددُ الذي تدور عليه
-- فحوصُ التخصيص كلُّها.
insert into projects (id, total_shares, shares_sold) values
  ('11111111-0000-0000-0000-000000000001', 100, 90);
...
insert into investments (id, project_id, investor_id, shares, status) values
  ...
  ('22222222-0000-0000-0000-000000000002',
   '11111111-0000-0000-0000-000000000001',
   'c0000000-0000-0000-0000-00000000000c', 40, 'pending'),
  -- مؤكَّدةٌ سلفاً — الطريقُ الصامتُ سابقاً
  ('22222222-0000-0000-0000-000000000003',
   '11111111-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-00000000000b', 1, 'confirmed');
